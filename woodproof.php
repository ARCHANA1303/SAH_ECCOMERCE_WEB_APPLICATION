...
<div class="heading">
    <h3>OUR products</h3>
    <p> <a href="product.php">product</a> / wood proofing </p>
</div>

<section class="products">

    <h1 class = "title">WOOD PROOFING</h1>

    <div class="box-container">

        <?php 
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE product_use = 'woodproof'") or die('query failed');
