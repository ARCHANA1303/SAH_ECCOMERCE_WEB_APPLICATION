...
<div class="heading">
    <h3>Cart</h3>
    <p> <a href="cart.php">cart</a> > <a href="cart.php" style="color: orange;">checkout</a> > <a href="orders.php">payment</a>  </p>
</div>
...
<section class="display-order">
    ...
    <p> <?php echo $fetch_cart['name']; ?> <span><?php echo $fetch_cart['price'] .'x'. $fetch_cart['quantity']; ?></span> =  <span><?php echo $fetch_cart['price'] * $fetch_cart['quantity']; ?></span></p>
    ...
    <form action="" method="post">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <select name="method">
                    <option value="cash on payment">cash on payment</option>
