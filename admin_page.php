    ...
    <div class="box-container">
        <div class="box">
            <?php 
                ...
                `order` WHERE payment_status = 'pending'") or die('query failed');
        ...
        <div class="box">
            <?php 
                ...
                `order` WHERE payment_status = 'completed'") or die('query failed');
        ...
        <div class="box">
            <?php
                $select_orders = mysqli_query($conn,"SELECT * FROM `order`") or
                die('query failed');
        ...
        <div class="box">
            ...
            <a href="admin_users.php"><p>total account</p></a>
        </div>
        <div class="box">
            <?php
                $select_supplier = mysqli_query($conn,"SELECT * FROM `supplier`") or
                die('query failed');
                $number_of_account = mysqli_num_rows($select_supplier);
            ?>
            <h3><?php echo $number_of_account; ?></h3>
            <a href="admin_supplier.php"><p>total supplier</p></a>
        </div>
        <div class="box">
            <?php
