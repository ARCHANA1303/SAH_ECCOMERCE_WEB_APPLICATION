    ...
    <div class = "box-container">
        ...
        <div class="box">
            ...
            <form action="" method="post">
                ...
                <h2>quantity: <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>"></h2>
                <h2> litre: <input type="number" min="1" name="product_quantity" value="<?php echo $fetch_cart['product_quantity']; ?>"></h2>
                <h2>Color picker<input type="color" id="favcolor" name="color" value="<?php echo $fetch_cart['color']; ?>"></h2>
                <!-- <input type="submit"> -->
                <input type="submit" name="update_cart" value="update" class="option-btn">
            </form>
            <div class = "sub-total"> sub total: <sapn>Rs. <?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price'] * $fetch_cart['product_quantity']); ?>/-</span></div>
        </div>
